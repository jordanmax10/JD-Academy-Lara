        ...
        <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    aria-describedby="file_input_help" name="imagenProfile" type="file" required>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="file_input_help">JPEG, PNG, JPG  (MAX.
                    800x400px).</p>
            </div>
